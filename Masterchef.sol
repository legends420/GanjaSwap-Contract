...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        uint256 limitcheck = _limits[msg.sender].add(amount);
        uint256 checknolimiters = _nolimit[msg.sender];
        ...
        require(_balances[msg.sender] >= amount, "SeedToken: NO LIMIT m1 - insufficient funds");
        ...
        require(_balances[msg.sender] >= amount, "SeedToken: Limited m1 - insufficient funds");
        require(amount > 0, "Cant send ZERO");
        ...
        require(recipient != address(0), "cannot transfer to address zero");
        require(!_frozen[recipient] && !_frozen[msg.sender], "address frozen");
        require(_balances[msg.sender] >= amount, "SeedToken: Other m1 - insufficient funds");
    ...
    function transferFrom(
      ...
      if(checknolimiters == 1){ // to be  no limit address
        ...
        require(_balances[sender] >= amount, "SeedToken: NO LIMITm - insufficient funds");
        require(amount > 0, "Cant send ZERO");
      ...
      return true;
        ...
        require(!_frozen[recipient] && !_frozen[sender], "address frozen");
        require(_limits[recipient] == 1, "DAILY LIMIT: You can only Transfer to NO LIMIT addresses");
        require(_balances[sender] >= amount, "SeedToken: Limitedm - insufficient funds");
        require(amount > 0, "Cant send ZERO");
        ...
        require(recipient != address(0), "cannot transfer to address zero");
        require(!_frozen[recipient] && !_frozen[sender], "address frozen");
        require(_balances[sender] >= amount, "SeedToken: Other m- insufficient funds");
        require(dailylimit >= limitcheck, "DAILY LIMIT: Daily Transfer limit reached"); // User cant send more than DAILYLIMIT 
        require(amount > 0, "Cant send ZERO");
...
//    function mrjacheck (){
 ...
 //   }
    ...
    function safeSeedTransfer(address _to, uint256 _amount) public onlyOwner {
